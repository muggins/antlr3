 ...
 *
*/
// $ANTLR 3.4 /Users/acondit/source/antlr/code/antlr3/runtime/ObjC/Framework/examples/polydiff/Poly.g 2012-05-27 21:14:52
...
- (PolyParser_poly_return *) poly
{
    ...
    @catch (RecognitionException *re) {
        ...
        // NSLog(@"poly returns %@", [((CommonTree *)retval.tree) descriptionTree]);
    }
...
- (PolyParser_term_return *) term
{
    ...
    @catch (RecognitionException *re) {
        ...
        /* ASTParser rule.setErrorReturnValue */
        retval.tree = (CommonTree *)[treeAdaptor errorNode:input From:retval.start To:[input LT:-1] Exception:re];
        // NSLog(@"term returns %@", [((CommonTree *)retval.tree) descriptionTree]);
    }
...
- (PolyParser_exp_return *) exp
{
    ...
    @catch (RecognitionException *re) {
        ...
        /* ASTParser rule.setErrorReturnValue */
        retval.tree = (CommonTree *)[treeAdaptor errorNode:input From:retval.start To:[input LT:-1] Exception:re];
        // NSLog(@"exp returns %@", [((CommonTree *)retval.tree) descriptionTree]);
    }
