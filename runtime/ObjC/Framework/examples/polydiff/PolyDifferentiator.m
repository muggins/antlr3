 ...
 *
*/
// $ANTLR 3.4 /Users/acondit/source/antlr/code/antlr3/runtime/ObjC/Framework/examples/polydiff/PolyDifferentiator.g 2012-05-27 18:23:05
    ...
    @try {
        ...
        switch (alt1) {
            ...
            case 3 : ;
                ...
                // 17:8: -> ^( MULT[@\"*\"] INT[c2] ^( '^' ID INT[e2] ) )
                {
                    // /Users/acondit/source/antlr/code/antlr3/runtime/ObjC/Framework/examples/polydiff/PolyDifferentiator.g:17:11: ^( MULT[@\"*\"] INT[c2] ^( '^' ID INT[e2] ) )
                    {
                        ...
                        root_1 = (CommonTree *)[treeAdaptor becomeRoot:[[treeAdaptor createTree:MULT Text:@"*"] retain] old:root_1];

                        [treeAdaptor addChild:[[treeAdaptor createTree:INT Text:c2] retain] toTree:root_1];
                        ...
                        // /Users/acondit/source/antlr/code/antlr3/runtime/ObjC/Framework/examples/polydiff/PolyDifferentiator.g:17:32: ^( '^' ID INT[e2] )
                        {
                            ...
                            [treeAdaptor addChild:[[treeAdaptor createTree:INT Text:e2] retain] toTree:root_2];
            ...
            case 5 : ;
                ...
                // 24:12: -> INT[@\"0\"]
                {
                    [treeAdaptor addChild:[[treeAdaptor createTree:INT Text:@"0"] retain] toTree:root_0];
